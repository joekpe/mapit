<?php
	class User{
		...
		public static function register($institution_id, $user_id, $user_full_name, $user_email, $user_password, $user_phone, $institution_name, $hash){
			...
			$institution_reg = $database->query_db("INSERT INTO institutions(institution_id, institution_name) VALUES('".$institution_id."', '".$institution_name."')");
			$user_institution_reg = $database->query_db("INSERT INTO user_institutions(user_id, institution_id, access_level) VALUES('".$user_id."', '".$institution_id."', '".POWER."')");
		...
		public static function create_admin($institution_id, $user_id, $user_full_name, $user_email, $user_password, $user_phone){
			...
			$user_institution_reg = $database->query_db("INSERT INTO user_institutions(user_id, institution_id, access_level) VALUES('".$user_id."', '".$institution_id."', '".ADMIN."')");
		...
		public static function create_client($full_name, $email, $password, $primary_phone, $secondary_phone, $institution_id, $created_by){
			global $database;
			$result = $database->query_db("INSERT INTO users(full_name, email, password, primary_phone, secondary_phone, institution_id, access_level, created_by) VALUES('".$full_name."', '".$email."', '".sha1($password)."', '".$primary_phone."', '".$secondary_phone."', '".$institution_id."', '".CLIENT."', '".$created_by."')");
			return $result;
		}
