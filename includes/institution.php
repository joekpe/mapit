<?php
	class Institution{
		...
		public static function new_institution($name, $email, $primary_phone, $secondary_phone){
			global $database;
			$result = $database->query_db("INSERT INTO institutions(institution_name, email, primary_phone, secondary_phone) VALUES('".$name."', '".$email."', '".$primary_phone."', '".$secondary_phone."')");
			return $result;
		}
